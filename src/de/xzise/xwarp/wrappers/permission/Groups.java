...
public class Groups {
    ...
    public static final Group<PermissionValues> PRICES_TO_GROUP = new Group<PermissionValues>(PermissionValues.WARP_PRICES_TO_PRIVATE, PermissionValues.WARP_PRICES_TO_PUBLIC, PermissionValues.WARP_PRICES_TO_GLOBAL);
    public static final Group<PermissionValues> PRICES_CREATE_GROUP = new Group<PermissionValues>(PermissionValues.WARP_PRICES_CREATE_PRIVATE, PermissionValues.WARP_PRICES_CREATE_PUBLIC, PermissionValues.WARP_PRICES_CREATE_GLOBAL);

...
public enum WarpPermissions implements PermissionDouble, Editor {
    ...
    public static final ReverseEnumMap<Character, WarpPermissions> CHARACTER_MAP = new ReverseEnumMap<Character, WarpPermissions>(WarpPermissions.class, EditorPermissionUtil.VALUE_CALLBACK);
    public static final ReverseEnumMap<Integer, WarpPermissions> ID_MAP = new ReverseEnumMap<Integer, WarpPermissions>(WarpPermissions.class, EditorPermissionUtil.ID_CALLBACK);

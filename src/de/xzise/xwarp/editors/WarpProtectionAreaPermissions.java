...
public enum WarpProtectionAreaPermissions implements PermissionDouble, Editor {
    ...
    public static final ReverseEnumMap<Character, WarpProtectionAreaPermissions> CHARACTER_MAP = new ReverseEnumMap<Character, WarpProtectionAreaPermissions>(WarpProtectionAreaPermissions.class, EditorPermissionUtil.VALUE_CALLBACK);
    public static final ReverseEnumMap<Integer, WarpProtectionAreaPermissions> ID_MAP = new ReverseEnumMap<Integer, WarpProtectionAreaPermissions>(WarpProtectionAreaPermissions.class, EditorPermissionUtil.ID_CALLBACK);
